...
export default function Community() {
  ...
  // 게시글 보기 핸들러
  const handleViewPost = (questionId: number) => {
    // 게시글 페이지 URL에 해당하는 경로 생성
    const postPath = `/community/question/${questionId}`;
    // 해당 경로로 이동
    navigate(postPath);
  };
  ...
  return (
    <Container>
      <div className="flex my-[77px] ml-[96px] mr-[443px] border border-blue-500">
        {/* 왼쪽 영역 */}
        <SideBar handleWritePost={handleWritePost} />

        {/* 오른쪽 영역 */}
        <div className="ml-[87px] border border-red-500">
          <PostList
