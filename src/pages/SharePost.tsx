    ...
    useEffect(() => {
        async function fetchData() {
          try {
            ...
            const posts: IPost[] = shareData.content || [];
            const foundPost = posts.find((item: IPost) => item.shareId === Number(shareId));
            if (foundPost) {
              setPosts(foundPost);
            } else {
                    ...
                    <div className="px-[41px] py-[39px] w-[1191px] h-[655px] bg-gray-100 rounded-3xl">
                        <div>
                          <div className="flex justify-between">
                            ...
                            <p className="my-[20px]">{post.userId} | {formattedDate} | 운동 루틴방</p>
