  ...
  return (
    <Container>
      <div className="flex flex-col justify-start items-center pt-8 min-h-screen bg-slate-100">
        ...
        <form onSubmit={handleSubmit(onValid)} className="flex flex-row w-auto">
          <div
            className={`${
          ...
          >
            ...
            >
              ...
              >
                <h2 className="absolute left-4 top-3 text-slate-500">1타임</h2>
                <h2
                  className={`text-right ${
                    isTime.first === null ? "text-slate-300" : "text-slate-500"
                  }`}
                >
                  {isTime.first === null
                    ? "선호 시간대를 정해주세요"
              ...
              >
                ...
                <h2
                  className={`text-right ${
                    isTime.second === null ? "text-slate-300" : "text-slate-500"
                  }`}
                >
                  {isTime.second === null
                    ? "선호 시간대를 정해주세요"
